...
-- Copied from https://github.com/neovim/neovim/tree/master/runtime/colors, modified by Lucas Wiebe-Dembowski
-- Changed ColorColumn, Pmenu, PmenuSel for dark backgrounds.

vim.cmd.highlight('clear')
vim.g.colors_name = 'vimlucas'
...
if vim.o.background == 'light' then
  ...
  hi('ColorColumn',      { bg = '#00FF00',                               ctermbg = 'DarkRed' })
  ...
  hi('Pmenu',            { bg = '#191e29',                                ctermfg = 'Black', ctermbg = 'Magenta' })
  -- hi('PmenuSel',         { bg = 'DarkGrey',                              ctermfg = 'DarkGrey', ctermbg = 'Black' })
  hi('PmenuSel',         { bg = '#2f394f',                                ctermfg = 'DarkGrey', ctermbg = 'Black' })
